...
import loadingFont from "./assets/fonts/ProggySmall.ttf";
        ...
        scene: [
          {
            ...
            preload(){
              //OR "THIS" HERE 
                ...
                this.load.text('font',loadingFont)
                let loading = this.add.text(350, 240, 'Loading...', 70, "font");
    ...
    return (
      <>
        ...
        <div>
          ...
          <SaveMenu/>
          <div id="phaser-box"> {/* FIGURE OUT WHAT IT DOES HERE WITH GAME; 
          DO SOMETHING SIMILAR WITH PLAYER -- SO IT CAN BE PASSED AROUND ~~~ BETTER SOLUTION BELOW  */}
            <IonPhaser id="ion-phaser" game={game} initialize={initialize} />
          </div>
          <Footer />
      </> 
    )
